 ...
 * - Press 5 for initializing new array.
 * - Press 6 to delete the beginning element.
 * - Press 7 to delete the specific position element.
 * - Press 8 to delete the end element.
 *
